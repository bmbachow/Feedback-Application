...
class GymReviewViewController: UIViewController {
    ...
    @IBAction func submit(_ sender: Any) {
        ...
        DBHelper.inst.reviewGym(username: LoginViewController.user!, rating: averageRating)
