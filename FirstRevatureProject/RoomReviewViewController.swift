//
//  RoomReviewViewController.swift
...
class RoomReviewViewController: UIViewController {
    ...
    @IBAction func submit(_ sender: Any) {
        ...
        DBHelper.inst.reviewRoom(username: LoginViewController.user!, rating: averageRating)
