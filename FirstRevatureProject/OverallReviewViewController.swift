//
//  OverallReviewViewController.swift
...
class OverallReviewViewController: UIViewController {
    ...
    @IBAction func submit(_ sender: Any) {
        ...
        DBHelper.inst.reviewOverall(username: LoginViewController.user!, rating: averageRating)
